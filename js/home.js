...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .querySelectorAll(
      ".feature-card, .service-card, .testimonial-card, .insight-card, .pricing-card"
    )
  ...
  document
    ...
    .forEach((counter) => statsObserver.observe(counter));
  ...
  document.querySelectorAll(".pricing-card").forEach((card) => {
    ...
    if (button) {
      button.addEventListener("click", (e) => {
        ...
        showNotification(
          `You selected the ${planName} plan. Redirecting...`,
          "info"
        );
      });
    }
